...
export const FilterButton = styled.button`
  background: ${({ $active }) => $active ? '#f59e0b' : 'white'};
  ...
  &:hover {
    background: ${({ $active }) => $active ? '#d97706' : '#f3f4f6'};
    border-color: ${({ $active }) => $active ? '#d97706' : '#9ca3af'};
  }
`;
...
export const PaginationButton = styled.button`
  background: ${({ disabled }) => disabled ? '#e5e7eb' : '#f59e0b'};
