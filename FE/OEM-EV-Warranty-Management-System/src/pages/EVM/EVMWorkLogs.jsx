...
import * as S from './EVMWorkLogs.styles';
import {
  ...
  return (
    <S.PageContainer>
      <S.Header>
        ...
        <S.HeaderSubtitle>
          Xem nhật ký công việc của tất cả technician
        </S.HeaderSubtitle>
      </S.Header>
      ...
      <S.NoticeBanner>
        ...
        <div>
          <strong>Lưu ý quan trọng:</strong> Work Log được tự động tạo khi:
