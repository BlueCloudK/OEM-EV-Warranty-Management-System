...
export default function Home() {
  return (
    <main>
      {/* Hero Section */}
      <section style={{ className: "hero-mint", background: "linear-gradient(180deg,#dff8f0 0%, #d5fbf0 100%)", padding: "56px 0", borderBottomLeftRadius: "20px", borderBottomRightRadius: "20px" }}>
